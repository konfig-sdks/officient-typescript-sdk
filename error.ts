...
/**
 * This class provides a wrapper for network errors when making requests to Officient API
 */
export class OfficientError extends Error {
  /**
   * The response body
   */
