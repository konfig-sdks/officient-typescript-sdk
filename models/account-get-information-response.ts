...
import { AccountGetInformationResponseData } from './account-get-information-response-data';

/**
 * 
 * @export
 * @interface AccountGetInformationResponse
 */
export interface AccountGetInformationResponse {
    /**
     * 
     * @type {AccountGetInformationResponseData}
     * @memberof AccountGetInformationResponse
     */
