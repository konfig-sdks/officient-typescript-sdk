...
import { AssetAddCustomTypeResponseData } from './asset-add-custom-type-response-data';

/**
 * 
 * @export
 * @interface AssetAddCustomTypeResponse
 */
export interface AssetAddCustomTypeResponse {
    /**
     * 
     * @type {AssetAddCustomTypeResponseData}
     * @memberof AssetAddCustomTypeResponse
     */
