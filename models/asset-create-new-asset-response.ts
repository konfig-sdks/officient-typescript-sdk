...
import { AssetCreateNewAssetResponseData } from './asset-create-new-asset-response-data';

/**
 * 
 * @export
 * @interface AssetCreateNewAssetResponse
 */
export interface AssetCreateNewAssetResponse {
    /**
     * 
     * @type {AssetCreateNewAssetResponseData}
     * @memberof AssetCreateNewAssetResponse
     */
