 ...
 * 
 * @export
 * @interface AssetGetCustomTypesListResponseDataInner
 */
export interface AssetGetCustomTypesListResponseDataInner {
    /**
     * 
     * @type {string}
     * @memberof AssetGetCustomTypesListResponseDataInner
     */
    'description'?: string;
    /**
     * 
