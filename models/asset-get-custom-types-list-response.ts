...
import { AssetGetCustomTypesListResponseDataInner } from './asset-get-custom-types-list-response-data-inner';

/**
 * 
 * @export
 * @interface AssetGetCustomTypesListResponse
 */
export interface AssetGetCustomTypesListResponse {
    /**
     * 
     * @type {Array<AssetGetCustomTypesListResponseDataInner>}
     * @memberof AssetGetCustomTypesListResponse
     */
    'data'?: Array<AssetGetCustomTypesListResponseDataInner>;
}
