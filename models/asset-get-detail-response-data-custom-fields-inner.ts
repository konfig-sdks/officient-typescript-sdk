 ...
 * 
 * @export
 * @interface AssetGetDetailResponseDataCustomFieldsInner
 */
export interface AssetGetDetailResponseDataCustomFieldsInner {
    /**
     * 
     * @type {string}
     * @memberof AssetGetDetailResponseDataCustomFieldsInner
     */
