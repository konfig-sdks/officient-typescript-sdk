...
import { AssetGetDetailResponseData } from './asset-get-detail-response-data';

/**
 * 
 * @export
 * @interface AssetGetDetailResponse
 */
export interface AssetGetDetailResponse {
    /**
     * 
     * @type {AssetGetDetailResponseData}
     * @memberof AssetGetDetailResponse
     */
