...
import { AssetListAssetsResponseDataInnerOwner } from './asset-list-assets-response-data-inner-owner';

/**
 * 
 * @export
 * @interface AssetListAssetsResponseDataInner
 */
export interface AssetListAssetsResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof AssetListAssetsResponseDataInner
     */
    'id'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {AssetListAssetsResponseDataInnerOwner}
     * @memberof AssetListAssetsResponseDataInner
     */
    'owner'?: AssetListAssetsResponseDataInnerOwner;
}
