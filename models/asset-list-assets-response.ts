...
import { AssetListAssetsResponseDataInner } from './asset-list-assets-response-data-inner';

/**
 * 
 * @export
 * @interface AssetListAssetsResponse
 */
export interface AssetListAssetsResponse {
    /**
     * 
     * @type {Array<AssetListAssetsResponseDataInner>}
     * @memberof AssetListAssetsResponse
     */
    'data'?: Array<AssetListAssetsResponseDataInner>;
}
