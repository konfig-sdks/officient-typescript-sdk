 ...
 * 
 * @export
 * @interface CalendarStateUnlockMonthProcessedRequest
 */
export interface CalendarStateUnlockMonthProcessedRequest {
    /**
     * By disabling the lock, the calendar will become unlocked.
     * @type {boolean}
     * @memberof CalendarStateUnlockMonthProcessedRequest
     */
