 ...
 * 
 * @export
 * @interface CalendarStateUnlockMonthProcessedResponse
 */
export interface CalendarStateUnlockMonthProcessedResponse {
    /**
     * 
     * @type {number}
     * @memberof CalendarStateUnlockMonthProcessedResponse
     */
    'success'?: number;
}
