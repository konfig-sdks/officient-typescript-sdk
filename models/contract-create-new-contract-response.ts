...
import { ContractCreateNewContractResponseData } from './contract-create-new-contract-response-data';

/**
 * 
 * @export
 * @interface ContractCreateNewContractResponse
 */
export interface ContractCreateNewContractResponse {
    /**
     * 
     * @type {ContractCreateNewContractResponseData}
     * @memberof ContractCreateNewContractResponse
     */
