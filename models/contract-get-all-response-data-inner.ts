...
import { ContractGetAllResponseDataInnerOwner } from './contract-get-all-response-data-inner-owner';

/**
 * 
 * @export
 * @interface ContractGetAllResponseDataInner
 */
export interface ContractGetAllResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof ContractGetAllResponseDataInner
     */
    'id'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {ContractGetAllResponseDataInnerOwner}
     * @memberof ContractGetAllResponseDataInner
     */
    'owner'?: ContractGetAllResponseDataInnerOwner;
}
