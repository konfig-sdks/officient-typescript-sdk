...
import { ContractGetAllResponseDataInner } from './contract-get-all-response-data-inner';

/**
 * 
 * @export
 * @interface ContractGetAllResponse
 */
export interface ContractGetAllResponse {
    /**
     * 
     * @type {Array<ContractGetAllResponseDataInner>}
     * @memberof ContractGetAllResponse
     */
    'data'?: Array<ContractGetAllResponseDataInner>;
}
