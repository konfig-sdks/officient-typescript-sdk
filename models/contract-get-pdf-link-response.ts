...
import { ContractGetPdfLinkResponseData } from './contract-get-pdf-link-response-data';

/**
 * 
 * @export
 * @interface ContractGetPdfLinkResponse
 */
export interface ContractGetPdfLinkResponse {
    /**
     * 
     * @type {ContractGetPdfLinkResponseData}
     * @memberof ContractGetPdfLinkResponse
     */
