 ...
 * 
 * @export
 * @interface CustomEventTypeGetListResponseDataInnerIntegrationsInner
 */
export interface CustomEventTypeGetListResponseDataInnerIntegrationsInner {
    /**
     * 
     * @type {string}
     * @memberof CustomEventTypeGetListResponseDataInnerIntegrationsInner
     */
    'app'?: string;
    /**
     * 
