...
import { CustomEventTypeGetListResponseDataInner } from './custom-event-type-get-list-response-data-inner';

/**
 * 
 * @export
 * @interface CustomEventTypeGetListResponse
 */
export interface CustomEventTypeGetListResponse {
    /**
     * 
     * @type {Array<CustomEventTypeGetListResponseDataInner>}
     * @memberof CustomEventTypeGetListResponse
     */
    'data'?: Array<CustomEventTypeGetListResponseDataInner>;
}
