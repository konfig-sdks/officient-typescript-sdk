 ...
 * 
 * @export
 * @interface CustomFieldListFieldsResponseDataInner
 */
export interface CustomFieldListFieldsResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof CustomFieldListFieldsResponseDataInner
     */
    'id'?: number;
    /**
     * 
