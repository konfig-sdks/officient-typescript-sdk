...
import { CustomFieldListFieldsResponseDataInner } from './custom-field-list-fields-response-data-inner';

/**
 * 
 * @export
 * @interface CustomFieldListFieldsResponse
 */
export interface CustomFieldListFieldsResponse {
    /**
     * 
     * @type {Array<CustomFieldListFieldsResponseDataInner>}
     * @memberof CustomFieldListFieldsResponse
     */
    'data'?: Array<CustomFieldListFieldsResponseDataInner>;
}
