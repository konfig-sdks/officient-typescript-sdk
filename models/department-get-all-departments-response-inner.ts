 ...
 * 
 * @export
 * @interface DepartmentGetAllDepartmentsResponseInner
 */
export interface DepartmentGetAllDepartmentsResponseInner {
    /**
     * 
     * @type {string}
     * @memberof DepartmentGetAllDepartmentsResponseInner
     */
    'description'?: string;
    /**
     * 
