...
import { DocumentGetDownloadUrlResponseData } from './document-get-download-url-response-data';

/**
 * 
 * @export
 * @interface DocumentGetDownloadUrlResponse
 */
export interface DocumentGetDownloadUrlResponse {
    /**
     * 
     * @type {DocumentGetDownloadUrlResponseData}
     * @memberof DocumentGetDownloadUrlResponse
     */
