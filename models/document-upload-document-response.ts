...
import { DocumentUploadDocumentResponseData } from './document-upload-document-response-data';

/**
 * 
 * @export
 * @interface DocumentUploadDocumentResponse
 */
export interface DocumentUploadDocumentResponse {
    /**
     * 
     * @type {DocumentUploadDocumentResponseData}
     * @memberof DocumentUploadDocumentResponse
     */
