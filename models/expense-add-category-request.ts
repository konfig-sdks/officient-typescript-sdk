 ...
 * 
 * @export
 * @interface ExpenseAddCategoryRequest
 */
export interface ExpenseAddCategoryRequest {
    /**
     * 
     * @type {string}
     * @memberof ExpenseAddCategoryRequest
     */
    'name': string;
    /**
     * 
     ...
     * @memberof ExpenseAddCategoryRequest
     */
    'type': ExpenseAddCategoryRequestTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof ExpenseAddCategoryRequest
     */
    'price-per-kilometer'?: number;
    /**
     * 
     * @type {number}
     * @memberof ExpenseAddCategoryRequest
...
type ExpenseAddCategoryRequestTypeEnum = 'total' | 'kilometer-allowance' | 'day-allowance'
