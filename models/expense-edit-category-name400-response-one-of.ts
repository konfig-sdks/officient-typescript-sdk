 ...
 * 
 * @export
 * @interface ExpenseEditCategoryName400ResponseOneOf
 */
export interface ExpenseEditCategoryName400ResponseOneOf {
    /**
     * 
     * @type {number}
     * @memberof ExpenseEditCategoryName400ResponseOneOf
     */
    'status_code'?: number;
    /**
     * 
