...
import { ExpenseGetDetailResponseData } from './expense-get-detail-response-data';

/**
 * 
 * @export
 * @interface ExpenseGetDetailResponse
 */
export interface ExpenseGetDetailResponse {
    /**
     * 
     * @type {ExpenseGetDetailResponseData}
     * @memberof ExpenseGetDetailResponse
     */
