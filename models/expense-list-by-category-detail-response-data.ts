 ...
 * 
 * @export
 * @interface ExpenseListByCategoryDetailResponseData
 */
export interface ExpenseListByCategoryDetailResponseData {
    /**
     * 
     * @type {number}
     * @memberof ExpenseListByCategoryDetailResponseData
     */
    'id'?: number;
    /**
     * 
