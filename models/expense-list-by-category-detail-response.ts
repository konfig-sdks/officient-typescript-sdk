...
import { ExpenseListByCategoryDetailResponseData } from './expense-list-by-category-detail-response-data';

/**
 * 
 * @export
 * @interface ExpenseListByCategoryDetailResponse
 */
export interface ExpenseListByCategoryDetailResponse {
    /**
     * 
     * @type {ExpenseListByCategoryDetailResponseData}
     * @memberof ExpenseListByCategoryDetailResponse
     */
