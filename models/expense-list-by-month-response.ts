...
import { ExpenseListByMonthResponseDataInner } from './expense-list-by-month-response-data-inner';

/**
 * 
 * @export
 * @interface ExpenseListByMonthResponse
 */
export interface ExpenseListByMonthResponse {
    /**
     * 
     * @type {Array<ExpenseListByMonthResponseDataInner>}
     * @memberof ExpenseListByMonthResponse
     */
    'data'?: Array<ExpenseListByMonthResponseDataInner>;
}
