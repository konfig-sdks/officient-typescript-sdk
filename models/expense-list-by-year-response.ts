...
import { ExpenseListByYearResponseDataInner } from './expense-list-by-year-response-data-inner';

/**
 * 
 * @export
 * @interface ExpenseListByYearResponse
 */
export interface ExpenseListByYearResponse {
    /**
     * 
     * @type {Array<ExpenseListByYearResponseDataInner>}
     * @memberof ExpenseListByYearResponse
     */
    'data'?: Array<ExpenseListByYearResponseDataInner>;
}
