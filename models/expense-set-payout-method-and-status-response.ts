 ...
 * 
 * @export
 * @interface ExpenseSetPayoutMethodAndStatusResponse
 */
export interface ExpenseSetPayoutMethodAndStatusResponse {
    /**
     * 
     * @type {number}
     * @memberof ExpenseSetPayoutMethodAndStatusResponse
     */
    'success'?: number;
}
