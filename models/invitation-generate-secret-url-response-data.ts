 ...
 * 
 * @export
 * @interface InvitationGenerateSecretUrlResponseData
 */
export interface InvitationGenerateSecretUrlResponseData {
    /**
     * 
     * @type {string}
     * @memberof InvitationGenerateSecretUrlResponseData
     */
    'secret_url'?: string;
}
