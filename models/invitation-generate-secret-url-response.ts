...
import { InvitationGenerateSecretUrlResponseData } from './invitation-generate-secret-url-response-data';

/**
 * 
 * @export
 * @interface InvitationGenerateSecretUrlResponse
 */
export interface InvitationGenerateSecretUrlResponse {
    /**
     * 
     * @type {InvitationGenerateSecretUrlResponseData}
     * @memberof InvitationGenerateSecretUrlResponse
     */
