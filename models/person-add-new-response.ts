...
import { PersonAddNewResponseData } from './person-add-new-response-data';

/**
 * 
 * @export
 * @interface PersonAddNewResponse
 */
export interface PersonAddNewResponse {
    /**
     * 
     * @type {PersonAddNewResponseData}
     * @memberof PersonAddNewResponse
     */
