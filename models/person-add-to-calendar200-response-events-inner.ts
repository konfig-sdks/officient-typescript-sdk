 ...
 * 
 * @export
 * @interface PersonAddToCalendar200ResponseEventsInner
 */
export interface PersonAddToCalendar200ResponseEventsInner {
    /**
     * 
     * @type {string}
     * @memberof PersonAddToCalendar200ResponseEventsInner
     */
    'date'?: string;
    /**
     * 
