 ...
 * 
 * @export
 * @interface PersonGetBudgetsByYearResponseDataInner
 */
export interface PersonGetBudgetsByYearResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof PersonGetBudgetsByYearResponseDataInner
     */
    'id'?: number;
    /**
     * 
