...
import { PersonGetBudgetsByYearResponseDataInner } from './person-get-budgets-by-year-response-data-inner';

/**
 * 
 * @export
 * @interface PersonGetBudgetsByYearResponse
 */
export interface PersonGetBudgetsByYearResponse {
    /**
     * 
     * @type {Array<PersonGetBudgetsByYearResponseDataInner>}
     * @memberof PersonGetBudgetsByYearResponse
     */
    'data'?: Array<PersonGetBudgetsByYearResponseDataInner>;
}
