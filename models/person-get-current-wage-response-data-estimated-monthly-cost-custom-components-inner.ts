 ...
 * 
 * @export
 * @interface PersonGetCurrentWageResponseDataEstimatedMonthlyCostCustomComponentsInner
 */
export interface PersonGetCurrentWageResponseDataEstimatedMonthlyCostCustomComponentsInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetCurrentWageResponseDataEstimatedMonthlyCostCustomComponentsInner
     */
    'description'?: string;
    /**
     * 
