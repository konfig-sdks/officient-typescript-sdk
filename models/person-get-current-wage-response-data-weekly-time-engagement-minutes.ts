 ...
 * 
 * @export
 * @interface PersonGetCurrentWageResponseDataWeeklyTimeEngagementMinutes
 */
export interface PersonGetCurrentWageResponseDataWeeklyTimeEngagementMinutes {
    /**
     * 
     * @type {number}
     * @memberof PersonGetCurrentWageResponseDataWeeklyTimeEngagementMinutes
     */
    'monday'?: number;
    /**
     * 
