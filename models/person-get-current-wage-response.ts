...
import { PersonGetCurrentWageResponseData } from './person-get-current-wage-response-data';

/**
 * 
 * @export
 * @interface PersonGetCurrentWageResponse
 */
export interface PersonGetCurrentWageResponse {
    /**
     * 
     * @type {PersonGetCurrentWageResponseData}
     * @memberof PersonGetCurrentWageResponse
     */
