 ...
 * 
 * @export
 * @interface PersonGetCurrentWeeklySchedule400ResponseOneOf
 */
export interface PersonGetCurrentWeeklySchedule400ResponseOneOf {
    /**
     * 
     * @type {number}
     * @memberof PersonGetCurrentWeeklySchedule400ResponseOneOf
     */
    'status_code'?: number;
    /**
     * 
