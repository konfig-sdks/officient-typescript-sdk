 ...
 * 
 * @export
 * @interface PersonGetCurrentWeeklySchedule400ResponseOneOf1
 */
export interface PersonGetCurrentWeeklySchedule400ResponseOneOf1 {
    /**
     * 
     * @type {number}
     * @memberof PersonGetCurrentWeeklySchedule400ResponseOneOf1
     */
    'status_code'?: number;
    /**
     * 
