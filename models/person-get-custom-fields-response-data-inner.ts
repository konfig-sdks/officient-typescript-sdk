 ...
 * 
 * @export
 * @interface PersonGetCustomFieldsResponseDataInner
 */
export interface PersonGetCustomFieldsResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof PersonGetCustomFieldsResponseDataInner
     */
