...
import { PersonGetCustomFieldsResponseDataInner } from './person-get-custom-fields-response-data-inner';

/**
 * 
 * @export
 * @interface PersonGetCustomFieldsResponse
 */
export interface PersonGetCustomFieldsResponse {
    /**
     * 
     * @type {Array<PersonGetCustomFieldsResponseDataInner>}
     * @memberof PersonGetCustomFieldsResponse
     */
    'data'?: Array<PersonGetCustomFieldsResponseDataInner>;
}
