 ...
 * 
 * @export
 * @interface PersonGetCustomFields400ResponseOneOf1
 */
export interface PersonGetCustomFields400ResponseOneOf1 {
    /**
     * 
     * @type {number}
     * @memberof PersonGetCustomFields400ResponseOneOf1
     */
    'status_code'?: number;
    /**
     * 
