...
import { PersonGetDailyCalendarResponseData } from './person-get-daily-calendar-response-data';

/**
 * 
 * @export
 * @interface PersonGetDailyCalendarResponse
 */
export interface PersonGetDailyCalendarResponse {
    /**
     * 
     * @type {PersonGetDailyCalendarResponseData}
     * @memberof PersonGetDailyCalendarResponse
     */
