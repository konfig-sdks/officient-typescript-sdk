 ...
 * 
 * @export
 * @interface PersonGetDetailResponseDataCurrentReportsTo
 */
export interface PersonGetDetailResponseDataCurrentReportsTo {
    /**
     * 
     * @type {number}
     * @memberof PersonGetDetailResponseDataCurrentReportsTo
     */
    'person_id'?: number;
    /**
     * 
