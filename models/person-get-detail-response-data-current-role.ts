 ...
 * 
 * @export
 * @interface PersonGetDetailResponseDataCurrentRole
 */
export interface PersonGetDetailResponseDataCurrentRole {
    /**
     * 
     * @type {string}
     * @memberof PersonGetDetailResponseDataCurrentRole
     */
    'name'?: string;
    /**
     * 
