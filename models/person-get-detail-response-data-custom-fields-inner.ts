 ...
 * 
 * @export
 * @interface PersonGetDetailResponseDataCustomFieldsInner
 */
export interface PersonGetDetailResponseDataCustomFieldsInner {
    /**
     * 
     * @type {number}
     * @memberof PersonGetDetailResponseDataCustomFieldsInner
     */
