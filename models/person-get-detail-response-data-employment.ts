 ...
 * 
 * @export
 * @interface PersonGetDetailResponseDataEmployment
 */
export interface PersonGetDetailResponseDataEmployment {
    /**
     * 
     * @type {string}
     * @memberof PersonGetDetailResponseDataEmployment
     */
