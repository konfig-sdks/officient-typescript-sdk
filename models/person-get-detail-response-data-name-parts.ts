 ...
 * 
 * @export
 * @interface PersonGetDetailResponseDataNameParts
 */
export interface PersonGetDetailResponseDataNameParts {
    /**
     * 
     * @type {string}
     * @memberof PersonGetDetailResponseDataNameParts
     */
    'initials'?: string;
    /**
     * 
     ...
     * @memberof PersonGetDetailResponseDataNameParts
     */
    'last_name_composition'?: string;
    /**
     * 
     * @type {string}
     * @memberof PersonGetDetailResponseDataNameParts
     */
    'insertion_partner'?: string;
    /**
     * 
     * @type {string}
     * @memberof PersonGetDetailResponseDataNameParts
