...
import { PersonGetDetailResponseData } from './person-get-detail-response-data';

/**
 * 
 * @export
 * @interface PersonGetDetailResponse
 */
export interface PersonGetDetailResponse {
    /**
     * 
     * @type {PersonGetDetailResponseData}
     * @memberof PersonGetDetailResponse
     */
