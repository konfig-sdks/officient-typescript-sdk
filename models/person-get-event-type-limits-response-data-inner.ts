 ...
 * 
 * @export
 * @interface PersonGetEventTypeLimitsResponseDataInner
 */
export interface PersonGetEventTypeLimitsResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof PersonGetEventTypeLimitsResponseDataInner
     */
    'id'?: number;
    /**
     * 
