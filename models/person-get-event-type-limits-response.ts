...
import { PersonGetEventTypeLimitsResponseDataInner } from './person-get-event-type-limits-response-data-inner';

/**
 * 
 * @export
 * @interface PersonGetEventTypeLimitsResponse
 */
export interface PersonGetEventTypeLimitsResponse {
    /**
     * 
     * @type {Array<PersonGetEventTypeLimitsResponseDataInner>}
     * @memberof PersonGetEventTypeLimitsResponse
     */
    'data'?: Array<PersonGetEventTypeLimitsResponseDataInner>;
}
