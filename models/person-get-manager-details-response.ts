...
import { PersonGetManagerDetailsResponseData } from './person-get-manager-details-response-data';

/**
 * 
 * @export
 * @interface PersonGetManagerDetailsResponse
 */
export interface PersonGetManagerDetailsResponse {
    /**
     * 
     * @type {PersonGetManagerDetailsResponseData}
     * @memberof PersonGetManagerDetailsResponse
     */
