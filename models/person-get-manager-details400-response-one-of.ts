 ...
 * 
 * @export
 * @interface PersonGetManagerDetails400ResponseOneOf
 */
export interface PersonGetManagerDetails400ResponseOneOf {
    /**
     * 
     * @type {number}
     * @memberof PersonGetManagerDetails400ResponseOneOf
     */
    'status_code'?: number;
    /**
     * 
