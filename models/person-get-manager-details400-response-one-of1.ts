 ...
 * 
 * @export
 * @interface PersonGetManagerDetails400ResponseOneOf1
 */
export interface PersonGetManagerDetails400ResponseOneOf1 {
    /**
     * 
     * @type {number}
     * @memberof PersonGetManagerDetails400ResponseOneOf1
     */
    'status_code'?: number;
    /**
     * 
