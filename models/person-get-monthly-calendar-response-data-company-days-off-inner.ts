 ...
 * 
 * @export
 * @interface PersonGetMonthlyCalendarResponseDataCompanyDaysOffInner
 */
export interface PersonGetMonthlyCalendarResponseDataCompanyDaysOffInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetMonthlyCalendarResponseDataCompanyDaysOffInner
     */
    'name'?: string;
    /**
     * 
