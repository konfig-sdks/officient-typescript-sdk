 ...
 * 
 * @export
 * @interface PersonGetMonthlyCalendarResponseDataTimeOffInner
 */
export interface PersonGetMonthlyCalendarResponseDataTimeOffInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetMonthlyCalendarResponseDataTimeOffInner
     */
    'date'?: string;
    /**
     * 
