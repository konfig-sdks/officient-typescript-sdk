...
import { PersonGetMonthlyCalendarResponseData } from './person-get-monthly-calendar-response-data';

/**
 * 
 * @export
 * @interface PersonGetMonthlyCalendarResponse
 */
export interface PersonGetMonthlyCalendarResponse {
    /**
     * 
     * @type {PersonGetMonthlyCalendarResponseData}
     * @memberof PersonGetMonthlyCalendarResponse
     */
