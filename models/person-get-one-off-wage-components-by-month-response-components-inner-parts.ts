 ...
 * 
 * @export
 * @interface PersonGetOneOffWageComponentsByMonthResponseComponentsInnerParts
 */
export interface PersonGetOneOffWageComponentsByMonthResponseComponentsInnerParts {
    /**
     * 
     * @type {string}
     * @memberof PersonGetOneOffWageComponentsByMonthResponseComponentsInnerParts
     */
    'unity'?: string;
    /**
     * 
