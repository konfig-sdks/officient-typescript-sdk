 ...
 * 
 * @export
 * @interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCity
 */
export interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCity {
    /**
     * 
     * @type {string}
     * @memberof PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCity
     */
    'old'?: string;
    /**
     * 
