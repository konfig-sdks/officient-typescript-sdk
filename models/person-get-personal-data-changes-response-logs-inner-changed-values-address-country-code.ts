 ...
 * 
 * @export
 * @interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCountryCode
 */
export interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCountryCode {
    /**
     * 
     * @type {string}
     * @memberof PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressCountryCode
     */
    'old'?: string;
    /**
     * 
