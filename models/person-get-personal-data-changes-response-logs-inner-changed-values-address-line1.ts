 ...
 * 
 * @export
 * @interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressLine1
 */
export interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressLine1 {
    /**
     * 
     * @type {string}
     * @memberof PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressLine1
     */
    'old'?: string;
    /**
     * 
