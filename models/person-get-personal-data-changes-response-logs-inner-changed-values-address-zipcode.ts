 ...
 * 
 * @export
 * @interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressZipcode
 */
export interface PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressZipcode {
    /**
     * 
     * @type {string}
     * @memberof PersonGetPersonalDataChangesResponseLogsInnerChangedValuesAddressZipcode
     */
    'old'?: string;
    /**
     * 
