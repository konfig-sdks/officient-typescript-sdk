 ...
 * 
 * @export
 * @interface PersonGetVerzuimPeriodsResponseDataInnerInner
 */
export interface PersonGetVerzuimPeriodsResponseDataInnerInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetVerzuimPeriodsResponseDataInnerInner
     */
    'start_date'?: string;
    /**
     * 
     ...
     * @memberof PersonGetVerzuimPeriodsResponseDataInnerInner
     */
    'duration_minutes_on_first_day'?: number;
    /**
     * 
     * @type {string}
     * @memberof PersonGetVerzuimPeriodsResponseDataInnerInner
