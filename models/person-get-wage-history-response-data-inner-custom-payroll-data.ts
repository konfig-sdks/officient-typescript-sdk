 ...
 * 
 * @export
 * @interface PersonGetWageHistoryResponseDataInnerCustomPayrollData
 */
export interface PersonGetWageHistoryResponseDataInnerCustomPayrollData {
    /**
     * 
     * @type {string}
     * @memberof PersonGetWageHistoryResponseDataInnerCustomPayrollData
     */
