 ...
 * 
 * @export
 * @interface PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostBaseComponents
 */
export interface PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostBaseComponents {
    /**
     * 
     * @type {number}
     * @memberof PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostBaseComponents
     */
    'base_rate'?: number;
    /**
     * 
     ...
     * @memberof PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostBaseComponents
     */
    'hospitalization_insurance'?: number;
    /**
     * 
     * @type {number}
     * @memberof PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostBaseComponents
