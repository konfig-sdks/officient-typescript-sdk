 ...
 * 
 * @export
 * @interface PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostCustomComponentsInner
 */
export interface PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostCustomComponentsInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetWageHistoryResponseDataInnerEstimatedMonthlyCostCustomComponentsInner
     */
    'description'?: string;
    /**
     * 
