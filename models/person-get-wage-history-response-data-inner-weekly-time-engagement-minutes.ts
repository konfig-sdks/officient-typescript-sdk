 ...
 * 
 * @export
 * @interface PersonGetWageHistoryResponseDataInnerWeeklyTimeEngagementMinutes
 */
export interface PersonGetWageHistoryResponseDataInnerWeeklyTimeEngagementMinutes {
    /**
     * 
     * @type {number}
     * @memberof PersonGetWageHistoryResponseDataInnerWeeklyTimeEngagementMinutes
     */
    'monday'?: number;
    /**
     * 
