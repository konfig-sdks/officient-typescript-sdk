...
import { PersonGetWageHistoryResponseDataInner } from './person-get-wage-history-response-data-inner';

/**
 * 
 * @export
 * @interface PersonGetWageHistoryResponse
 */
export interface PersonGetWageHistoryResponse {
    /**
     * 
     * @type {Array<PersonGetWageHistoryResponseDataInner>}
     * @memberof PersonGetWageHistoryResponse
     */
    'data'?: Array<PersonGetWageHistoryResponseDataInner>;
}
