 ...
 * 
 * @export
 * @interface PersonGetYearlyCalendarResponseDataCompanyDaysOffInner
 */
export interface PersonGetYearlyCalendarResponseDataCompanyDaysOffInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetYearlyCalendarResponseDataCompanyDaysOffInner
     */
    'name'?: string;
    /**
     * 
