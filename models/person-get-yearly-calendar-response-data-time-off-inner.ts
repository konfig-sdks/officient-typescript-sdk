 ...
 * 
 * @export
 * @interface PersonGetYearlyCalendarResponseDataTimeOffInner
 */
export interface PersonGetYearlyCalendarResponseDataTimeOffInner {
    /**
     * 
     * @type {string}
     * @memberof PersonGetYearlyCalendarResponseDataTimeOffInner
     */
    'date'?: string;
    /**
     * 
