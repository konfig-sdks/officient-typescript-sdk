...
import { PersonGetYearlyCalendarResponseData } from './person-get-yearly-calendar-response-data';

/**
 * 
 * @export
 * @interface PersonGetYearlyCalendarResponse
 */
export interface PersonGetYearlyCalendarResponse {
    /**
     * 
     * @type {PersonGetYearlyCalendarResponseData}
     * @memberof PersonGetYearlyCalendarResponse
     */
