...
import { PersonListBudgetItemsResponseDataInner } from './person-list-budget-items-response-data-inner';

/**
 * 
 * @export
 * @interface PersonListBudgetItemsResponse
 */
export interface PersonListBudgetItemsResponse {
    /**
     * 
     * @type {Array<PersonListBudgetItemsResponseDataInner>}
     * @memberof PersonListBudgetItemsResponse
     */
    'data'?: Array<PersonListBudgetItemsResponseDataInner>;
}
