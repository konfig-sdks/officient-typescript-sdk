 ...
 * 
 * @export
 * @interface PersonListDimonasByPersonResponseDimonasInner
 */
export interface PersonListDimonasByPersonResponseDimonasInner {
    /**
     * 
     * @type {number}
     * @memberof PersonListDimonasByPersonResponseDimonasInner
     */
    'dimona_number'?: number;
    /**
     * 
     * @type {string}
     * @memberof PersonListDimonasByPersonResponseDimonasInner
     ...
     * @memberof PersonListDimonasByPersonResponseDimonasInner
     */
    'initiated_via_officient'?: number;
}
