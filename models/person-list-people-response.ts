...
import { PersonListPeopleResponseDataInner } from './person-list-people-response-data-inner';

/**
 * 
 * @export
 * @interface PersonListPeopleResponse
 */
export interface PersonListPeopleResponse {
    /**
     * 
     * @type {Array<PersonListPeopleResponseDataInner>}
     * @memberof PersonListPeopleResponse
     */
    'data'?: Array<PersonListPeopleResponseDataInner>;
    /**
     * 
     * @type {number}
     * @memberof PersonListPeopleResponse
