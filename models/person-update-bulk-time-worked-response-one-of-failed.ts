 ...
 * 
 * @export
 * @interface PersonUpdateBulkTimeWorkedResponseOneOfFailed
 */
export interface PersonUpdateBulkTimeWorkedResponseOneOfFailed {
    /**
     * 
     * @type {string}
     * @memberof PersonUpdateBulkTimeWorkedResponseOneOfFailed
     */
    'date'?: string;
    /**
     * 
