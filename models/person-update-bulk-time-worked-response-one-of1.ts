 ...
 * 
 * @export
 * @interface PersonUpdateBulkTimeWorkedResponseOneOf1
 */
export interface PersonUpdateBulkTimeWorkedResponseOneOf1 {
    /**
     * 
     * @type {number}
     * @memberof PersonUpdateBulkTimeWorkedResponseOneOf1
     */
    'success'?: number;
    /**
     * 
