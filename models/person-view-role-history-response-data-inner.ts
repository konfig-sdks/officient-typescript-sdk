 ...
 * 
 * @export
 * @interface PersonViewRoleHistoryResponseDataInner
 */
export interface PersonViewRoleHistoryResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof PersonViewRoleHistoryResponseDataInner
     */
    'id'?: number;
    /**
     * 
