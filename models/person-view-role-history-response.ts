...
import { PersonViewRoleHistoryResponseDataInner } from './person-view-role-history-response-data-inner';

/**
 * 
 * @export
 * @interface PersonViewRoleHistoryResponse
 */
export interface PersonViewRoleHistoryResponse {
    /**
     * 
     * @type {Array<PersonViewRoleHistoryResponseDataInner>}
     * @memberof PersonViewRoleHistoryResponse
     */
    'data'?: Array<PersonViewRoleHistoryResponseDataInner>;
}
