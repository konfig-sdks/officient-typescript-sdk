 ...
 * 
 * @export
 * @interface PrioritySchemeListActivePrioritySchemesByYearResponseDataInner
 */
export interface PrioritySchemeListActivePrioritySchemesByYearResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof PrioritySchemeListActivePrioritySchemesByYearResponseDataInner
     */
    'id'?: number;
    /**
     * 
