...
import { TeamGetAllTeamsResponseDataInner } from './team-get-all-teams-response-data-inner';

/**
 * 
 * @export
 * @interface TeamGetAllTeamsResponse
 */
export interface TeamGetAllTeamsResponse {
    /**
     * 
     * @type {Array<TeamGetAllTeamsResponseDataInner>}
     * @memberof TeamGetAllTeamsResponse
     */
    'data'?: Array<TeamGetAllTeamsResponseDataInner>;
}
