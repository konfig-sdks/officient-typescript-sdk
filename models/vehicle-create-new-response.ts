...
import { VehicleCreateNewResponseData } from './vehicle-create-new-response-data';

/**
 * 
 * @export
 * @interface VehicleCreateNewResponse
 */
export interface VehicleCreateNewResponse {
    /**
     * 
     * @type {VehicleCreateNewResponseData}
     * @memberof VehicleCreateNewResponse
     */
