 ...
 * 
 * @export
 * @interface VehicleGetAllVehiclesResponseDataInnerOwner
 */
export interface VehicleGetAllVehiclesResponseDataInnerOwner {
    /**
     * 
     * @type {number}
     * @memberof VehicleGetAllVehiclesResponseDataInnerOwner
     */
    'id'?: number;
    /**
     * 
