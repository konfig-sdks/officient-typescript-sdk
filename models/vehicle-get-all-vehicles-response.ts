...
import { VehicleGetAllVehiclesResponseDataInner } from './vehicle-get-all-vehicles-response-data-inner';

/**
 * 
 * @export
 * @interface VehicleGetAllVehiclesResponse
 */
export interface VehicleGetAllVehiclesResponse {
    /**
     * 
     * @type {Array<VehicleGetAllVehiclesResponseDataInner>}
     * @memberof VehicleGetAllVehiclesResponse
     */
    'data'?: Array<VehicleGetAllVehiclesResponseDataInner>;
}
