 ...
 * 
 * @export
 * @interface VehicleGetDetailResponseDataCustomFieldsInner
 */
export interface VehicleGetDetailResponseDataCustomFieldsInner {
    /**
     * 
     * @type {string}
     * @memberof VehicleGetDetailResponseDataCustomFieldsInner
     */
