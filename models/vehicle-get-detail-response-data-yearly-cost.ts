 ...
 * 
 * @export
 * @interface VehicleGetDetailResponseDataYearlyCost
 */
export interface VehicleGetDetailResponseDataYearlyCost {
    /**
     * 
     * @type {string}
     * @memberof VehicleGetDetailResponseDataYearlyCost
     */
    'base'?: string;
    /**
     * 
