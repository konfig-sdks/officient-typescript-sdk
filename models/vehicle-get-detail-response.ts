...
import { VehicleGetDetailResponseData } from './vehicle-get-detail-response-data';

/**
 * 
 * @export
 * @interface VehicleGetDetailResponse
 */
export interface VehicleGetDetailResponse {
    /**
     * 
     * @type {VehicleGetDetailResponseData}
     * @memberof VehicleGetDetailResponse
     */
