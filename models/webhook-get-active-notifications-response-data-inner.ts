 ...
 * 
 * @export
 * @interface WebhookGetActiveNotificationsResponseDataInner
 */
export interface WebhookGetActiveNotificationsResponseDataInner {
    /**
     * 
     * @type {number}
     * @memberof WebhookGetActiveNotificationsResponseDataInner
     */
    'id'?: number;
    /**
     * 
