 ...
 * 
 * @export
 * @interface WebhookSubscribeNotificationResponseData
 */
export interface WebhookSubscribeNotificationResponseData {
    /**
     * 
     * @type {string}
     * @memberof WebhookSubscribeNotificationResponseData
     */
    'id'?: string;
}
