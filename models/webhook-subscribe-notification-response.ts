...
import { WebhookSubscribeNotificationResponseData } from './webhook-subscribe-notification-response-data';

/**
 * 
 * @export
 * @interface WebhookSubscribeNotificationResponse
 */
export interface WebhookSubscribeNotificationResponse {
    /**
     * 
     * @type {WebhookSubscribeNotificationResponseData}
     * @memberof WebhookSubscribeNotificationResponse
     */
